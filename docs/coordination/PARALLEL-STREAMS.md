...
|---|---|---|---|
| M6.5 · pygame runtime | 🔄 **Phase 2 in flight** (2026-06-10) | `../trellis-m65` / `m6.5-pygame` | User-sequenced ahead of M6 (rebuild capstone = pygame game). Phase 1 plan reviewed+approved (`docs/superpowers/plans/2026-06-10-trellis-m6.5-pygame.md`; D1–D4 + A1–A6 dispositioned; A3 conservative pre-check accepted; A7 CI-pygame deferred to orchestrator @ Task 15). **§17.4 `graphical` schema seam LANDED @ `532385c`** (test-first, 8 validity tests, additive-optional; workspace **466**; design note: headless-aware preamble amends §17.3/§17.6). Phase 2 = `@trellis/runtime` + sandbox headless-grading path + client PygameStage + proving fixture + real-browser Playwright defining gate. |
